        ...
        <div class="uk-margin">
            ...
            <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <select
                        class="uk-select uk-form-width-large"
                        v-model="node.theme.sectionSize"
                    >
            ...
            <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <input-image
                        ...
                        v-model="node.theme.sectionImage"
                        :value="node.theme.sectionImage"
                    ></input-image>
                </div>
            </div>
        </div>
        ...
        <div class="uk-margin">
            <div class="uk-margin">
                ...
                <div class="uk-form-controls">
                    <select
                        class="uk-select uk-form-width-large"
                        v-model="node.theme.contentAlign"
                    >
                        <option value="">{{ "Default" | trans }}</option>
            ...
            <div class="uk-alert-warning" uk-alert>
                {{
                    "Title Conf: It should only be used for the page plugin."
                        | trans
                }}
            </div>
            <div>
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        <select
                            class="uk-select uk-form-width-large"
                            v-model="node.theme.titleDomElement"
                        >
                ...
                <div class="uk-margin">
                    ...
                    <div class="uk-form-controls">
                        ...
                        >
                            ...
                            <option value="uk-text-muted">{{
                                "Muted" | trans
                            }}</option>
                            <option value="uk-text-emphasis">{{
                                "Muted" | trans
                            }}</option>
                            <option value="uk-text-success">{{
                                "Muted" | trans
                            }}</option>
                            <option value="uk-text-warning">{{
                                "Muted" | trans
                            }}</option>
                            <option value="uk-text-danger">{{
                                "Muted" | trans
                            }}</option>
                        </select>
                    </div>
